...
from blackdog_core.state import create_prompt_receipt, prompt_receipt_reference
from blackdog_cli.main import main as blackdog_main
from tests.core_audit_support import CoreAuditTestCase


def _write_stats_session(home: Path, *, cwd: Path, thread_id: str, turn_id: str, started_at: str) -> None:
    ...
    rows = [
        ...
        },
        {
            "timestamp": started_at,
            "type": "event_msg",
            "payload": {"type": "user_message", "message": "Implement stats fixture."},
        },
        {
            "timestamp": started_at,
            "type": "response_item",

...
class BlackdogCliTests(unittest.TestCase):
    ...
    def test_snapshot_models_objective_rows_with_progress_summaries(self) -> None:
        ...
        self.assertIn('document.getElementById("objectives-table-body").innerHTML = objectiveRows.length', html)
    ...
    def test_snapshot_exposes_active_tasks_filters_messages_and_interrupts_empty_runs(self) -> None:
        ...
        self.assertIn('document.getElementById("release-gates-list").innerHTML = releaseGates.length', html)
        ...
        self.assertIn('document.getElementById("hero-progress-label").textContent = progressLabel(overallProgress);', html)
    ...
    def test_render_writes_static_html_with_embedded_snapshot(self) -> None:
        ...
        self.assertIn('document.getElementById("objectives-table-body").innerHTML = objectiveRows.length', updated_html)
        ...
        self.assertIn('document.getElementById("release-gates-list").innerHTML = releaseGates.length', updated_html)

...
class BlackdogCliTests(unittest.TestCase):
    ...
    def test_snapshot_exposes_active_tasks_filters_messages_and_interrupts_empty_runs(self) -> None:
        ...
        self.assertIn('data-hero-section="workspace"', html)
        self.assertIn('data-hero-section="board-snapshot"', html)
        self.assertIn('data-hero-section="artifacts"', html)
        self.assertIn('id="backlog-panel"', html)
        self.assertIn('id="backlog-controls"', html)
        self.assertIn('id="status-legend"', html)
        self.assertIn('id="hero-progress"', html)
        self.assertIn('id="completed-history-panel"', html)
    ...
    def test_render_writes_static_html_with_embedded_snapshot(self) -> None:
        ...
        self.assertIn('id="backlog-controls"', updated_html)
        self.assertIn('id="board-guide"', updated_html)
        self.assertIn('id="status-legend"', updated_html)
        ...
        self.assertIn('id="hero-progress-label"', updated_html)
        self.assertIn('id="hero-progress-detail"', updated_html)
        self.assertIn("function renderLegend()", updated_html)
        ...
        self.assertIn('class="legend"', updated_html)
        self.assertIn(".legend-dot.tone-running { background: var(--running-fg); }", updated_html)
        self.assertIn(".progress-fill {", updated_html)
        self.assertIn(".progress-hero .progress-fill {", updated_html)
        self.assertIn('id="completed-history-panel"', updated_html)
        self.assertIn("<h2>Completed Tasks</h2>", updated_html)
        self.assertIn('id="completed-history-scroll"', updated_html)
        self.assertIn('data-history-limit="30"', updated_html)
        self.assertIn('class="result-history"', updated_html)
        self.assertIn("const COMPLETED_HISTORY_LIMIT = 30;", updated_html)
        self.assertIn("Showing latest ${visibleCount} of ${completed.length} completed", updated_html)
        self.assertIn("completed.slice(0, COMPLETED_HISTORY_LIMIT)", updated_html)
        self.assertIn('grid-template-areas:\n    "hero"\n    "backlog"\n    "history";', updated_html)
        self.assertIn("grid-template-columns: minmax(0, 1fr);", updated_html)
        self.assertIn("grid-template-columns: minmax(0, 1fr) minmax(260px, 360px);", updated_html)
        self.assertIn("grid-template-columns: repeat(3, minmax(0, 1fr));", updated_html)
        self.assertIn("max-height: min(32rem, 70vh);", updated_html)
        self.assertIn("overflow-y: auto;", updated_html)
        ...
        self.assertNotIn("Execution Map", updated_html)
        self.assertNotIn("Top to bottom lane order", updated_html)
        self.assertNotIn("Wave Boundary", updated_html)

...
success path cannot finish. Retryable operational landing blockers keep the
active attempt retryable; the agent fixes the blocker and reruns `task land` or

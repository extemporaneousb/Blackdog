...
9. Open `{profile.paths.html_file}` directly when you want the static task index; `blackdog render` refreshes it and active supervisor runs rerender it after task-state changes.

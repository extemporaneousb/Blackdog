...
from blackdog_core import backlog as core_backlog
...
def _tune_task_payload(
    profile: RepoProfile,
    *,
    analysis_builder: Callable[[RepoProfile], dict[str, Any]] = build_tune_analysis,
) -> dict[str, Any]:
...
def seed_tune_task(
    profile: RepoProfile,
    *,
    tune_task_payload_builder: Callable[[RepoProfile], dict[str, Any]] = _tune_task_payload,

...
from blackdog_core.backlog import BacklogTask
...
def _dynamic_reasoning_effort_for_task(profile: RepoProfile, task: BacklogTask) -> str:
...
def launch_defaults_view(profile: RepoProfile, settings: dict[str, Any]) -> dict[str, Any]:
    view = dict(settings)

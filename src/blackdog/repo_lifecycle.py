...
def render_repo_skill(profile: RepoProfile) -> str:
    ...
    scaffold_workflow = ""
    repo_lifecycle_surface = "`repo analyze`, `repo install`, `repo update`, `repo refresh`, `attempts summary`, `attempts table`"
    if blackdog_source_skill:
        ...
        repo_lifecycle_surface = "`repo analyze`, `repo install`, `repo scaffold`, `repo update`, `repo refresh`, `attempts summary`, `attempts table`"
    return (
        "---\n"
        f"name: {skill_name}\n"
